...
import 'package:vsfm/view/screens/bouncer_detail_screen/bouncer_detail_screen.dart';
import 'package:vsfm/view/widget/custom_button.dart';
import 'package:vsfm/view/widget/custom_text.dart';

class BouncerTile extends StatelessWidget {
  const BouncerTile({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomButton(
                        name: "View Profile", 
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => BouncerDetailScreen()));
                        }
                      ),
                      const SizedBox(height: 10),
                      CustomButton(
